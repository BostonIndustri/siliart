<aside id="left" class="widget-area group-widget-area sm-wb-grid-1-4 md-wb-grid-1-5" role="complementary">
		...
		<div class="widget">
			<div id="item-actions">
				...
				<?php if ( bp_group_is_visible() ) : ?>
					...
					<h4 class="widget-title"><span><?php _e( 'Group Admins', 'buddypress' ); ?></span></h4>
					...
					if ( bp_group_has_moderators() ) :
						...
						<h4 class="widget-title group-mods-title"><span><?php _e( 'Group Mods', 'buddypress' ); ?></span></h4>
	...
	<?php do_action( 'reign_end_group_left_sidebar' ); ?>
</aside>
