			...
			<li <?php bp_member_class( array( 'item-entry' ) ); ?> data-bp-item-id="<?php bp_member_user_id(); ?>" data-bp-item-component="members">
				<div class="list-wrap
					...
					<div class="item-avatar">
						...
						?>
						<a href="<?php echo esc_url( $bp_get_member_permalink ); ?>" class="<?php echo esc_attr( $moderation_class ); ?> <?php echo esc_attr( $img_class ); ?>">
							<?php
					...
					<div class="member-buttons-wrap action-wrap">
						<?php
						if ( $member_directory_type === 'wbtm-member-directory-type-1' || $member_directory_type === 'wbtm-member-directory-type-3' ) {
					...
					<div class="bb_more_options member-dropdown">
						<a href="#" class="bb_more_options_action bp-tooltip" data-bp-tooltip-pos="up" data-bp-tooltip="<?php esc_html_e( 'More Options', 'reign' ); ?>">
