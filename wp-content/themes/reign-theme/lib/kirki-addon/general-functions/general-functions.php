...
function reign_color_scheme_set() {
	$color_schemes = array(
		'reign_default'   => array(
			...
			'reign_header_sub_menu_bg_color'           => '#404040',
			'reign_header_sub_menu_font'               => '#ffffff',
			'reign_header_sub_menu_text_hover_color'   => '#ffffff',
			'reign_header_sub_menu_bg_hover_color'     => '#505050',
			'reign_header_icon_color'                  => '#ffffff',
			'reign_header_icon_hover_color'            => '#ffffff',
		...
		'reign_dark'      => array(
			...
			'reign_header_topbar_text_color'           => '#b0b3b8',
			...
			'reign_header_main_menu_font'              => '#ffffff',
			'reign_header_main_menu_text_hover_color'  => '#e4e6eb',
			'reign_header_main_menu_text_active_color' => '#e4e6eb',
			'reign_header_main_menu_bg_hover_color'    => '#013a9a',
			'reign_header_main_menu_bg_active_color'   => '#013a9a',
			...
			'reign_mobile_menu_bg_color'               => '#1a2028',
			'reign_mobile_menu_color'                  => '#ffffff',
			'reign_mobile_menu_hover_color'            => '#e4e6eb',
			'reign_mobile_menu_active_color'           => '#e4e6eb',
			'reign_mobile_menu_active_bg_color'        => '',
			'reign_left_panel_bg_color'                => '#1a2028',
			'reign_left_panel_toggle_color'            => '#e4e6eb',
			'reign_left_panel_menu_font_color'         => '#ffffff',
			'reign_left_panel_menu_hover_color'        => '',
			'reign_left_panel_menu_active_color'       => '#e4e6eb',
			'reign_left_panel_menu_bg_hover_color'     => '',
			'reign_left_panel_menu_bg_active_color'    => '#013a9a',
			'reign_left_panel_menu_icon_active_color'  => '#ffffff',
			'reign_left_panel_tooltip_bg_color'        => '#383a45',
			'reign_left_panel_tooltip_color'           => '#ffffff',
			'reign_site_body_bg_color'                 => '#23262f',
			'reign_site_body_text_color'               => '#bfbfbf',
			'reign_site_alternate_text_color'          => '#a7a7a7',
			'reign_colors_theme'                       => '#3772ff',
			'reign_site_link_color'                    => '#ffffff',
			'reign_site_link_hover_color'              => '#013a9a',
			'reign_site_button_text_color'             => '#ffffff',
			'reign_site_button_text_hover_color'       => '#ffffff',
			'reign_site_button_bg_color'               => '#2b58c5',
			'reign_site_button_bg_hover_color'         => '#013a9a',
			'reign_accent_color'                       => '#ffffff',
			'reign_accent_hover_color'                 => '#013a9a',
