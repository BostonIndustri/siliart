...
<?php
	if($pmpro_invoice)
	{
		...
		<ul class="pmpro_billing_info_list">
			...
			<li class="level"><strong><?php esc_html_e('Membership Level', 'paid-memberships-pro' );?>:</strong> <?php echo esc_html( $pmpro_invoice->membership_level->name ); ?></li>
			<?php if ( ! empty( $pmpro_invoice->status ) ) { ?>
				<li class="level_fee"><strong><?php esc_html_e('Status', 'paid-memberships-pro' ); ?>:</strong>
				<?php
			...
			<?php if($pmpro_invoice->getDiscountCode()) { ?>
				<li class="level_dicount"><strong><?php esc_html_e('Discount Code', 'paid-memberships-pro' );?>:</strong> <?php echo esc_html( $pmpro_invoice->discount_code->code ); ?></li>
			<?php } ?>
