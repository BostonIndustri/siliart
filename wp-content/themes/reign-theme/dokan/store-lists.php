<div class="dokan-seller-listing">
	...
	$show_products = isset( $show_products ) ? $show_products : false;
	...
	$template_args = array(
		...
		'show_products'   => $show_products, // custom option added.
		'enable_slider'   => $enable_slider, // custom option added.
	);
