							...
							<div class="user-wrap">
								...
								<div>
									...
									if ( function_exists( 'bp_is_active' ) && bp_is_active( 'settings' ) ) {
										...
										?>
										<div class="my-account-link"><a class="ab-item" aria-haspopup="true" href="<?php echo esc_url( $settings_link ); ?>"><?php esc_html_e( 'My Account', 'reign' ); ?></a></div>
										<?php
									}
									?>
								</div>
										...
										if ( $mobile_menu_logo_enable ) {
											...
											if ( ! empty( $reign_header_mobile_menu_logo ) ) {
												...
												<a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">
													<img class="reign-mobile-menu" src="<?php echo esc_url( $reign_header_mobile_menu_logo ); ?>" />
												</a>
												<?php
											} else {
												the_custom_logo();
