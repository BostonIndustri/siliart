...
class BP_REIGN_ACTIVITY_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		$included_components = isset( $instance['included_components'] ) ? $instance['included_components'] : '';
		$excluded_components = isset( $instance['excluded_components'] ) ? $instance['excluded_components'] : '';
		...
		if ( isset( $args['before_title'] ) ) {
			if ( isset( $instance['title'] ) ) {
				echo $args['before_title'] . $instance['title']; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
			}
		} else {
			echo isset( $instance['title'] ) ? $instance['title'] : ''; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
		}

		if ( isset( $instance['show_feed_link'] ) ) {
			if ( $instance['show_feed_link'] == 'yes' ) {
				echo ' <a class="reign-rss" href="' . bp_get_sitewide_activity_feed_link() . '" title="' . esc_html__( 'Site Wide Activity RSS Feed', 'reign' ) . '">' . __( '[RSS]', 'reign' ) . '</a>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
			}
		}
		...
		<div class="aligncenter site-activity-view-all-button">
			<a class="rg-action button large" href="<?php echo home_url( '/' ) . bp_get_activity_slug(); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>">
	...
	public function form( $instance ) {
		...
		<div class="reign-widget-block">
			...
			<p>
				<label for="bp-reign-show-feed-link"><?php esc_html_e( 'Show Feed Link:', 'reign' ); ?>
					...
					<label for="<?php echo $this->get_field_id( 'show_feed_link' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>_no" > <input  id="<?php echo $this->get_field_id( 'show_feed_link' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>_no" name="<?php echo $this->get_field_name( 'show_feed_link' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>" type="radio" <?php checked( $instance['show_feed_link'], 'no' ); ?> value="no"  /><?php esc_html_e( 'No', 'reign' ); ?></label>
				</label>
			</p>
			<p>
		...
		<div class="reign-widget-block">
			...
			<p>
				...
				<?php foreach ( (array) $recorded_components as $component ) : ?>
					<label for="<?php echo esc_attr( $this->get_field_id( 'included_components' ) . '_' . $component ); ?>" ><?php echo esc_attr( ucwords( $component ) ); ?> <input id="<?php echo esc_attr( $this->get_field_id( 'included_components' ) . '_' . $component ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'included_components' ) ); ?>[]" type="checkbox"
										   <?php
		...
		<div class="reign-widget-block">
			...
			<p>
				...
				<?php foreach ( (array) $recorded_components as $component ) : ?>
					<label for="<?php echo esc_attr( $this->get_field_id( 'excluded_components' ) . '_' . $component ); ?>" ><?php echo esc_attr( ucwords( $component ) ); ?> <input id="<?php echo esc_attr( $this->get_field_id( 'excluded_components' ) . '_' . $component ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'excluded_components' ) ); ?>[]" type="checkbox"
										   <?php
