...
<div aria-live="polite" aria-relevant="all" aria-atomic="true">
	...
	<div class="bp-widget group-members-list group-admins-list">
		...
		array(
			...
			?>
			<ul id="admins-list" class="item-list wb-grid rg-member-list wb-grid <?php echo $member_directory_type; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>" aria-live="assertive" aria-relevant="all">
				<?php
					...
					<li <?php bp_member_class( array( 'wb-grid-cell', 'sm-wb-grid-1-1', 'md-wb-grid-1-2', $addition_class ) ); ?>>
						<div class="bp-inner-wrap">
							...
							<div class="item-avatar">
								...
								?>
								<a class="<?php echo esc_attr( $img_class ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>" href="<?php bp_group_member_domain(); ?>"><?php bp_group_member_avatar_thumb(); ?><?php echo reign_get_online_status( $user_id ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></a>
								<?php
								if ( $member_directory_type == 'wbtm-member-directory-type-4' ) {
									echo '</figure>';
								}
							...
							<div class="action-wrap">
								...
								<div class="action rg-dropdown">
									<?php if ( count( bp_group_admin_ids( false, 'array' ) ) > 1 ) : ?>
										<div><a class="button confirm admin-demote-to-member" href="<?php bp_group_member_demote_link(); ?>"><?php esc_html_e( 'Demote to Member', 'buddypress' ); ?></a></div>
									<?php endif; ?>
	...
	<div class="bp-widget group-members-list group-mods-list">
		...
		array(
			...
			<ul id="mods-list" class="item-list wb-grid rg-member-list wb-grid <?php echo $member_directory_type; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>" aria-live="assertive" aria-relevant="all">
					...
					<li <?php bp_member_class( array( 'wb-grid-cell', 'sm-wb-grid-1-1', 'md-wb-grid-1-2', $addition_class ) ); ?>>
						<div class="bp-inner-wrap">
							...
							<div class="action-wrap">
								<i class="far fa-plus-circle"></i>
								<div class="action rg-dropdown">
									<div><a href="<?php bp_group_member_promote_admin_link(); ?>" class="button confirm mod-promote-to-admin"><?php esc_html_e( 'Promote to Admin', 'buddypress' ); ?></a></div>
									<div><a class="button confirm mod-demote-to-member" href="<?php bp_group_member_demote_link(); ?>"><?php esc_html_e( 'Demote to Member', 'buddypress' ); ?></a></div>
					...
					<li <?php bp_member_class( array( 'wb-grid-cell', 'sm-wb-grid-1-1', 'md-wb-grid-1-2', $addition_class ) ); ?>>
						...
						<div class="bp-inner-wrap">
							...
							<div class="item-avatar">
								...
								?>
								<a class="<?php echo esc_attr( $img_class ); ?>" href="<?php bp_group_member_domain(); ?>"><?php bp_group_member_avatar_thumb(); ?><?php echo reign_get_online_status( $user_id ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></a>
								<?php
								if ( $member_directory_type == 'wbtm-member-directory-type-4' ) {
									echo '</figure>';
								}
							...
							<div class="action-wrap">
								...
								<div class="action rg-dropdown">
									<?php if ( bp_get_group_member_is_banned() ) : ?>
										...
										<div><a href="<?php bp_group_member_unban_link(); ?>" class="button confirm member-unban"><?php esc_html_e( 'Remove Ban', 'buddypress' ); ?></a></div>

									<?php else : ?>

										<div><a href="<?php bp_group_member_ban_link(); ?>" class="button confirm member-ban"><?php esc_html_e( 'Kick &amp; Ban', 'buddypress' ); ?></a></div>
										<div><a href="<?php bp_group_member_promote_mod_link(); ?>" class="button confirm member-promote-to-mod"><?php esc_html_e( 'Promote to Mod', 'buddypress' ); ?></a></div>
										<div><a href="<?php bp_group_member_promote_admin_link(); ?>" class="button confirm member-promote-to-admin"><?php esc_html_e( 'Promote to Admin', 'buddypress' ); ?></a></div>

									<?php endif; ?>

									<div><a href="<?php bp_group_member_remove_link(); ?>" class="button confirm"><?php esc_html_e( 'Remove from group', 'buddypress' ); ?></a></div>
