    ...
    <div class="ps-page ps-page--messages">
        ...
        <div class="ps-messages-page__nav-wrapper">
            <div class="ps-btn__group">
                <span  style="border-top-right-radius: 0 !important;border-bottom-right-radius: 0!important;" class="ps-btn ps-btn--sm ps-btn--app ps-btn--cp" aria-label="<?php echo __('Filter', 'peepso-core'); ?>">
                    <i class="gcis gci-filter"></i>
                </span>
                <a href="#" style="border-radius:0!important;" class="ps-btn ps-btn--sm ps-btn--app ps-btn--cp ps-tip ps-tip--arrow ps-js-messages-show-all active" aria-label="<?php echo __('All', 'peepso-core'); ?>">
                    <i class="gcis gci-list-check"></i> <?php echo __('All', 'peepso-core'); ?>
                </a>
                <a href="#" style="border-top-left-radius: 0 !important;border-bottom-left-radius: 0!important;" class="ps-btn ps-btn--sm ps-btn--app ps-btn--cp  ps-tip ps-tip--arrow  ps-js-messages-show-unread" aria-label="<?php echo __('Unread', 'peepso-core'); ?>">
                    <i class="gcis gci-exclamation-circle"></i> <?php echo __('Unread', 'peepso-core'); ?>
                </a>
            </div>
            <div class="ps-messages__nav-actions">
                <?php if (class_exists('PeepSoMessagesPlugin') && FALSE !== apply_filters('peepso_permissions_messages_create', TRUE)) { ?>
                    <a href="javascript:" class="ps-btn ps-btn--app ps-btn--sm  ps-tip ps-tip--arrow " onclick="ps_messages.new_message(undefined, 'is_friend')" aria-label="<?php echo __('New message', 'msgso'); ?>">
                        <i class="gcis gci-pen-to-square"></i> <?php echo __('New', 'msgso'); ?>
                    </a>
                <?php } ?>
            </div>
        </div>
