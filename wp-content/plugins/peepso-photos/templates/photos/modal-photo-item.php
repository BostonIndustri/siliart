<?php /**/
...
<?php if (intval($pho_owner_id) === get_current_user_id()) {
	...
	$set_album_cover_onclick = apply_filters('peepso_photos_set_as_album_cover', 'peepso.photos.set_as_album_cover({ photo_id: \'' . $pho_id . '\', album_id: \'' . $pho_album_id . '\' });', $pho_id, $params);
	?>
	<div class="ps-lightbox__object-actions ps-lightbox-toolbar--options">
		<div class="ps-lightbox__object-dropdown ps-dropdown ps-js-dropdown" id="picso-photo-setting">
			...
			<div class="ps-dropdown__menu ps-js-dropdown-menu">
				...
				<a href="#" onclick="<?php echo $set_album_cover_onclick;?>; return false;"><?php echo __('Set as album cover', 'picso'); ?></a>
			</div>
		</div>
	</div>
